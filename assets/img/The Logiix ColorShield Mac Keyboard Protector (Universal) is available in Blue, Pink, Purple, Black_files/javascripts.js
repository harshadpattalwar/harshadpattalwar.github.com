	...
	jQuery('form[name="SearchBoxForm"] input[name="Search"]').each(function() {
		...
		jQuery(this).autocomplete({
			...
			open: function(event, ui) {
			    ...
			    //not a great fix, but better than moving the functionality (?) to a separate CSS file.
				jQuery('ul.ui-autocomplete li.ui-menu-item a').css({ 'overflow-x': 'hidden', 'text-overflow': 'ellipsis' })

			    //We can do this in CSS now :)   http://caniuse.com/#feat=text-overflow
...
function setEllipses() {
    ...
    //This is no longer needed. We can do this in CSS. Kept for legacy reasons http://caniuse.com/#feat=text-overflow
